...
class ScaledDotProductAttention(nn.Module):
    def __init__(self,
        ...
        if ar:
            ...
            mask = torch.zeros(sizeSeq, sizeSeq)
...
def buildTransformer(dimEncoded,    # Output dimension of the encoder
    ...
    layerSequence += [TransformerLayer(sizeSeq=sizeSeq,
                                       dmodel=dimEncoded, abspos=abspos, ar=ar)
